...
import { Gamepad2, Wallet, Plus, ShieldAlert, ShoppingBag, ShieldCheck, UserCheck, ChevronDown, Check, LogOut, Sparkles, LogIn } from 'lucide-react';
...
export const Header: React.FC<HeaderProps> = ({
  ...
  const { currentUser, isAdmin, orders, switchUserRole, logout } = useStore();
              ...
              {!currentUser.isGoogleUser ? (
                ...
                >
                  ...
                  <div className="text-right hidden lg:block">
                    ...
                    <span className="text-[10px] text-cyan-300 block line-clamp-1">مسجل بالدخول</span>
                  </div>
